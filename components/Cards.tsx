...
const Cards = ({ variant, title, paragraph, number }: CradsProps) => {
  return (
    <div className={`${variant === 'primary' ? 'bg-black text-white'  : 'bg-purple-300 text-black'} sticky top-5 h-[400px] w-full rounded-3xl p-8 shadow-2xl transition-transform duration-300`}>
